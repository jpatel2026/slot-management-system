  ...
  return (
    <div>
      ...
      <Tabs defaultValue="summary">
        ...
        <TabsContent value="summary"><AllocationSummary siteType="Cryopreservation" filters={filters} /></TabsContent>
        <TabsContent value="weekly-util"><UtilizationTargets siteType="Cryopreservation" rangeType="Weekly" filters={filters} /></TabsContent>
        <TabsContent value="monthly-util"><UtilizationTargets siteType="Cryopreservation" rangeType="Monthly" filters={filters} /></TabsContent>
